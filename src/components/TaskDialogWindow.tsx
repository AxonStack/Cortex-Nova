...
export function TaskDialogWindow() {
  ...
  return (
    <div className="h-screen bg-[#d8d8d8] dark:bg-[#0f0f0f] p-4 font-mono transition-colors duration-200 overflow-hidden">
      <div className="h-full rounded-[28px] border-2 border-black dark:border-[#3a3a3a] bg-[#dfdfdf] dark:bg-[#171717] shadow-[0_10px_0_#000] dark:shadow-[0_10px_0_#2a2a2a] p-2">
        <div className="h-full rounded-[20px] border border-black dark:border-[#3a3a3a] bg-[#e8e8e8] dark:bg-[#1f1f1f] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 px-5 py-3 overflow-y-auto">
            {!activePlan ? (
              <div className="h-full flex items-center justify-center text-center text-[11px] tracking-[0.15em] uppercase text-black/35 dark:text-white/30">
                This window appears when Nova takes control of a desktop task.
              </div>
            ) : (
